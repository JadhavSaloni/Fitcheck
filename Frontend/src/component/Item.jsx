  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-lg">
      <div className="relative flex items-center justify-center group overflow-hidden transition-all duration-100">
        <Link
          to={`/product/${id}`}
          className="h-12 w-12 bg-whiterounded-full flexcenter absolute top-1/2 bottom-1/2 !py-2 z-20 scale-0 
            group-hover:scale-100 transition-all duration-700"
        >
          <FaSearch className="hover:rotate-90 hover:scale-125 duration-200" />
        </Link>
        <img
          src={image}
          alt="productImage"
      ...
      <div className="p-4 overflow-hidden">
        <h4 className="my-[6px] medium-16 line-clamp-2">{name}</h4>
